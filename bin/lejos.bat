...
java -Djava.library.path="%LEJOS_HOME%\bin" -classpath "%LINK_CLASSPATH%" js.tools.LejosLinkAndDownload --writeorder BE --classpath "%LINK_CLASSPATH%" -tty %RCX_PORT% %1 %2 %3 %4 %5 %6 %7 %8 %9

...
set LINK_CLASSPATH=.;%LEJOS_HOME%\lib\classes.jar;%LEJOS_HOME%\lib\jtools.jar;%THIRDPARTY_LIBS%\commons-cli-1.0.jar;%THIRDPARTY_LIBS%\bcel-5.1.jar;%LEJOS_HOME%\lib\pcrcxcomm.jar

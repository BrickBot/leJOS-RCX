...
abstract class JCPE_NamedEntry extends JConstantPoolEntry
{
   ...
   public JCPE_NamedEntry (IConstantPool aConstantPool, int aTag,
      JCPE_Utf8 aName) throws Exception
   {
      super(aConstantPool);
      iTag = aTag;
   ...
   public JCPE_NamedEntry (IConstantPool aConstantPool, int aTag, String aName)
      throws Exception
   {
      this(aConstantPool, aTag, (JCPE_Utf8) aConstantPool
         .getEntry(new JCPE_Utf8(aName)));
   }

...
public class JClassName implements IConstants
{
   ...
   public static String getMethodDescriptor (Class aParamTypes[], Class aRetType)
      throws Exception
   {
      ...
      //System.out.println ("");
      String pDesc = getMethodDescriptor(getDescriptorForClasses(aParamTypes),
   ...
   public static String getDescriptorForClass (Class aClass) throws Exception
   {
      ...
      {
         return getDescriptorForArray(getDescriptorForClass(aClass
            .getComponentType()));
      }
      else
   ...
   public static int[] getTypeAndDimensions (String aMultiArrayDesc)
   {
      ...
      return new int[]
      {
         descriptorToType(aMultiArrayDesc.substring(i)), i
      };
   }

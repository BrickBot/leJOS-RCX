...
public class JCPE_NameAndType extends JConstantPoolEntry
{
   ...
   public JCPE_NameAndType (IConstantPool aConstantPool, JCPE_Utf8 aName,
   ...
   public JCPE_NameAndType (IConstantPool aConstantPool, String aName,
      String aDescriptor) throws Exception
   {
      this(aConstantPool, new JCPE_Utf8(aName), new JCPE_Utf8(aDescriptor));
   }

   public JCPE_NameAndType (IConstantPool aConstantPool, Method aMethod)
      throws Exception
   {
      this(aConstantPool, aMethod.getName(), JClassName.getMethodDescriptor(
         aMethod.getParameterTypes(), aMethod.getReturnType()));
   }

   public JCPE_NameAndType (IConstantPool aConstantPool,
      Constructor aConstructor) throws Exception
   {
      this(aConstantPool, "<init>", JClassName.getMethodDescriptor(aConstructor
         .getParameterTypes(), void.class));
   }

   public JCPE_NameAndType (IConstantPool aConstantPool, Field aField)
      throws Exception
   {
      this(aConstantPool, aField.getName(), JClassName
         .getDescriptorForClass(aField.getType()));
   }
   ...
   public boolean equals (Object aObj)
   {
      if (aObj instanceof JCPE_NameAndType)
         return (iName.equals(((JCPE_NameAndType) aObj).iName) && iDescriptor
            .equals(((JCPE_NameAndType) aObj).iName));
      return false;
   }

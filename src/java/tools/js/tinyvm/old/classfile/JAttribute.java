...
public class JAttribute implements IDumpable
{
   ...
   public JAttribute (JConstantPool aConstantPool, JCPE_Utf8 aName,
      byte aInfo[])
   {
      iConstantPool = aConstantPool;
   ...
   public boolean equals (Object aObj)
   {
      if (aObj instanceof JAttribute)
         return (iName.equals(((JAttribute) aObj).iName) && iInfo
            .equals(((JAttribute) aObj).iInfo));
      return false;
   }
   ...
   /**
    * Reads everything after the name; that is, the part of the attribute that
    * starts at attribute_length.
    */

...
public abstract class JCPE_RefEntry extends JConstantPoolEntry
{
   ...
   public JCPE_RefEntry (IConstantPool aConstantPool, int aTag,
      JCPE_Class aClass, JCPE_NameAndType aNameAndType) throws Exception
   {
      super(aConstantPool);
      iTag = aTag;
   ...
   public final void update () throws Exception
   {
      ...
      iNameAndType = (JCPE_NameAndType) iConstantPool
         .getEntry(iNameAndTypeIndex);
   }
   ...
   public boolean equals (Object aObj)
   {
      if (aObj instanceof JCPE_RefEntry)
      {
         ...
         return (iClass.equals(pEntry.iClass) && iNameAndType
            .equals(pEntry.iNameAndType));
      }
      return false;
   }

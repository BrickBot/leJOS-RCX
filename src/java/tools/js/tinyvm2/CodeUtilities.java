...
public class CodeUtilities implements OpCodeConstants, OpCodeInfo, Constants
{
   ...
   public int processMultiArray (int aPoolIndex) throws TinyVMException
   {
      ...
      // TODO fix this
      // int[] pTypeDim =
      // JClassName.getTypeAndDimensions(pClassEntry.getName());
      int[] pTypeDim = new int[]
      {
         0, 0
      };
   ...
   int processField (int aFieldIndex, boolean aStatic) throws TinyVMException
   {
      ...
      // TODO use ConstantUtf8?
      String className = pFieldEntry.getClass(iCF.getConstantPool());
      ...
      throws TinyVMException
   {
      ...
      String className = pMethodEntry.getClass(iCF.getConstantPool());
      ClassRecord pClassRecord = iBinary.getClassRecord(className);
      if (pClassRecord == null)
      {
      ...
      // TODO fix this
      // ConstantNameAndType pNT = pMethodEntry.getNameAndType();
      ConstantNameAndType pNT = null;
      ...
      while (i < aCode.length)
      {
         ...
         switch (pOpCode)
         {
            ...
            case OP_ANEWARRAY:
               ...
               pOutCode[i++] = (byte) Constants.T_REFERENCE;
